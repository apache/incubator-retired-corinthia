...
struct _tidy_option
{
    ...
    unsigned long long  dflt;       /* default for TidyInteger and TidyBoolean */
...
typedef union
{
  uint  v;  /* Value for TidyInteger and TidyBoolean */
...
Bool TY_(SetOptionInt)( TidyDocImpl* doc, TidyOptionId optId, uint val );
...
uint    TY_(_cfgGet)( TidyDocImpl* doc, TidyOptionId optId );
